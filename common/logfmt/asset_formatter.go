...
func (s *AssetFormatter) Format(entry *logrus.Entry) ([]byte, error) {
...
type AssetFormatterWithFieldsOrder struct{}

func (s *AssetFormatterWithFieldsOrder) Format(entry *logrus.Entry) ([]byte, error) {
